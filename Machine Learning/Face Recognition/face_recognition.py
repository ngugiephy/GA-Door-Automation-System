...
img = cv.imread('jp1.jpg') #upload image of your choice
...
for (x,y,w,h) in rect:
    ...
    print(f'Label = {people[label]}of confidence{confidence}') #This prints out the label and the accuracy to which the model predicted the data presented
    cv.putText(img, str (people[label]), (20,20), cv.FONT_HERSHEY_COMPLEX, 1.0, (0,255,0), thickness=2) #allows printing of label onto the picture.
